...
const axios = require("axios"); // Agrega esta línea para importar axios
...
const enviarGMAIL = async (req, res) => {
  ...
  try {
    const response = await axios.post("http://hoteles.spring.informaticapp.com:3093/empleados/authenticate", { usuario, contrasena });
    ...
    const REFRESH_TOKEN =
      "1//04Dd_gYvw9VInCgYIARAAGAQSNwF-L9Ir2qSo7r5rttbm1nnjOBGKT7aTXExQul2O55F6wHOflklDsNamsXPHUElV07C6FdNgaM8";
